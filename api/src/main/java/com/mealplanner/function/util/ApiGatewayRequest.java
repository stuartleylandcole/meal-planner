 ...
 *
 * WARNING: The AWS docs appear to be somewhat inaccurate in the following way: - message property does not exist on request ( I suspect a copy/paste error, as
 * this is a response property of the example API in the docs) - input property contents is the top level object
 */
